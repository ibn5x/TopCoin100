...
fetch("https://api.nomics.com/v1/currencies/ticker?key=badc8cea9218d36fd1a3cc2461ce52e13ade6686&ids&ids=BTC,ETH,XRP&interval=1d,30d&convert=EUR&per-page=100&page=1")
.then(response => response.json())
.then(data => {
    for(let i = 0; i < 100; i++ ) {
        const Data = data[i];
